...
map_files_simple = ['find_key_0.txt', 'find_door_0.txt', 'find_enemies_0.txt']
...
map_files_complex = ['find_zelda_0.txt']
inicial_complex = []
...
# TAREA NUEVA
mapa_eval_2 = Mapa('find_zelda_1.txt')
initial_eval_2 = Estado(mapa_eval_2, (4,5), 0, 0, False, True)
...
# TAREAS NUEVAS
eval_key = Mapa('find_key_0.txt')
initial_key = Estado(eval_key, (1,1), 0, 0, False, True)

eval_door = Mapa('find_door_0.txt')
initial_door = Estado(eval_door, (1,1), 0, 0, True, True)

eval_enemies = Mapa('find_enemies_0.txt')
