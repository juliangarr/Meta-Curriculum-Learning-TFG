...
models_dir = "MODELS_prueba_R/REPTILE_KEY"
logs_dir    = "LOGS_prueba_R/REPTILE_KEY"
csv_dir = "CSV"
...
for mapa, pos, i in zip(mapas, posiciones, range(len(mapas))):
    ...
    model.learn(total_timesteps=TIMESTEPS, reset_num_timesteps=False, tb_log_name=f"Reptile_Key")
...
csv_filename = "key_Reptile"

evaluar_tarea(model_path, csv_filename, csv_dir, "REPTILE_KEY", level_files, posiciones, TASK)