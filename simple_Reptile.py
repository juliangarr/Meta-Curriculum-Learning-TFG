...
models_directories = ["MODELS_SIMPLE/KEY_REPTILE", "MODELS_SIMPLE/DOOR_REPTILE", "MODELS_SIMPLE/ENEMIES_REPTILE"]
logs_directories    = ["LOGS_SIMPLE/logs_KEY_REPTILE", "LOGS_SIMPLE/logs_DOOR_REPTILE", "LOGS_SIMPLE/logs_ENEMIES_REPTILE"]
csv_dir = "CSV"
