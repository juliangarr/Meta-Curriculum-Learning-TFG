...
logs_directories    = ["LOGS_SIMPLE/logs_KEY", "LOGS_SIMPLE/logs_DOOR", "LOGS_SIMPLE/logs_ENEMIES"]
csv_dir = "CSV"
...
csv_filename = "simple"
zelda_levels = ["zelada_0.txt", "zelda_1.txt", "zelda_2.txt", "zelda_3.txt", "zelda_4.txt"]
